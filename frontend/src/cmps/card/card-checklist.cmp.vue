    ...
    <section class="card-checklist">
        ...
        <div class="checklist-list-container">
            <ul v-if="checklist.todos">
                ...
                >
                    <button
                        class="checklist-btn-remove-todo"
                        @click="onRemoveTodo(index)"
                    >
        ...
        <button
            class="checklist-btn-add-item clr-btn"
            v-if="!isAddTodoForm"
            @click="onAddTodoForm"
        >
            Add an item
        ...
        <form
            class="add-todo-item-container flex"
            v-if="isAddTodoForm"
        ...
        >
            ...
            <button
                class="checklist-btn close-add-todo close"
                @click="onCloseAddTodo"
            >
                <i class="el-icon-close"></i>
            </button>
        </form>
